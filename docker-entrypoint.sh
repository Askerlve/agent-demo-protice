...
if [[ "$1" == "consumer" ]]; then
  ...
  java -jar -Xms1G -Xmx1G -Ddubbo.protocol.port=20889 /root/dists/mesh-provider.jar
elif [[ "$1" == "provider-medium" ]]; then
  echo "Starting medium provider service..."
  java -jar -Xms2G -Xmx2G -Ddubbo.protocol.port=20890 /root/dists/mesh-provider.jar
elif [[ "$1" == "provider-large" ]]; then
  echo "Starting large provider service..."
  java -jar -Xms3G -Xmx3G  -Ddubbo.protocol.port=20891 /root/dists/mesh-provider.jar
else
